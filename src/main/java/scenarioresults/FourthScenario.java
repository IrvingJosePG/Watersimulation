 ...
 * @author irvingjose
 */
public class FourthScenario extends javax.swing.JFrame {

    /**
     * Creates new form FourthScenario
     */
    public FourthScenario() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FourthScenario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FourthScenario().setVisible(true);
            }
        });
    }
