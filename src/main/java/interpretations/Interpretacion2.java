 ...
 * @author 52951
 */
public class Interpretacion2 extends javax.swing.JFrame {

    /**
     * Creates new form interpretacion2
     */
    public Interpretacion2() {
        initComponents();
    ...
    private void initComponents() {
        ...
        tittle.setText("Interpretación Segundo Escenario");
        gb.add(tittle, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 10, 430, -1));

        text1.setText("En este escenario, al mejorar las condiciones de conservación del ");
        ...
        text4.setText("siempre queda arriba de la azul.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Interpretacion2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
